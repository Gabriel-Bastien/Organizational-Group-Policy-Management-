...
| Path | Purpose |
|---|---|
| `policy-exports/` | Space reserved for exported GPO backups (`.zip`/GPO backup folders) if you export yours from GPMC |
| `docs/screenshots/` | Screenshots captured while building and deploying the GPO |
...
![GPMC console showing the domain's OU structure and existing GPOs](docs/screenshots/01-gpmc-console-overview.png)
...
![Creating a new GPO named GPO_Corporate_Security_Hardening](docs/screenshots/02-new-gpo-creation.png)
...
![Security Settings categories: Account Policies, Local Policies, Restricted Groups, and more](docs/screenshots/03-security-settings-categories.png)
...
![Local Policies subcategories](docs/screenshots/04-local-policies-categories.png)
...
![Full list of Security Options policies](docs/screenshots/05-security-options-list.png)
...
![Machine inactivity limit set to 900 seconds](docs/screenshots/06-inactivity-limit-900s.png)
...
![Setting the logon banner title](docs/screenshots/07-logon-banner-title.png)
...
![Logon banner title confirmed in the policy list](docs/screenshots/08-logon-banner-confirmed.png)
...
![Windows Settings node under User Configuration](docs/screenshots/09-windows-settings-node.png)
...
![Prohibit access to Control Panel and PC settings — Enabled](docs/screenshots/10-control-panel-restriction-enabled.png)
...
![Running gpupdate /force from an elevated command prompt](docs/screenshots/11-gpupdate-force.png)

A successful run confirms both the computer and user portions of the policy applied:

![gpupdate confirms Computer Policy and User Policy updated successfully](docs/screenshots/12-gpupdate-success.png)
